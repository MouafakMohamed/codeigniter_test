...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/app-assets/css/plugins/extensions/noui-slider.min.css">
...
<body class="vertical-layout vertical-menu-modern content-detached-left-sidebar ecommerce-application navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="content-detached-left-sidebar">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Les Produits</h2>
 ...
 multiple="multiple"
                ...
                <?php
                    ...
                    if ($num == 1) {
                       ...
                       $ok1 = $ok+4 ;
                        ...
                        echo '<li class="page-item "><a class="page-link" href="produit?page=1"> <<  </a></li>
                               <li class="page-item prev-item"><a class="page-link" href="produit?page='.$pre.'"></a></li>';

                    for ($page = $ok; $page <= $ok1; $page++) {
                    if ($page == $num) {
                    ...
                    echo '<li class="page-item next-item"><a class="page-link" href="produit?page='.$add.'"></a></li>
                          <li class="page-item"><a class="page-link" href="produit?page='.$n_pages.'"> >> </a></li>'
                        ?>
                                    </ul>
                                </nav>
                            </div>
                            ...
                            <div class="card-body" >
                                ...
                                <div id="product-categories">
                                    <div class="product-category-title">
                                        <h6 class="filter-title mb-1">Catégories</h6>
                                    </div>
                                ...
                                <div class="brands">
                                    <div class="brand-title mt-1 pb-1">
                                        <h6 class="filter-title mb-0">Marque</h6>
                                    </div>
    ...
    <?php foreach ($query1 as $key) {  ?> <div class="modal fade text-left" id="danger<?php echo $key->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                            ...
                                                            <div class="modal-content">
                                                               ...
                                                               <center> <h1 style="font-size:40px">  <i class="fa fa-trash-o"></i></h1></center>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <a href="delete_pro?id=<?php echo $key->id; ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
                                              ...
                                              Marque
                                                ...
                                                <fieldset class="form-group position-relative input-divider-right">
                                                   <select class="form-control" name="marque" id="basicSelect" required="">
                                                        <?php if (!empty($key->marque)) {
                                                          $marque1 = $this->Model->get_by('marques','id',$key->marque);
                                                            foreach ($marque1 as $cat5) { ?>
                                                                <option value="<?php echo $cat5->id; ?>"><?php echo $cat5->name; ?></option>
                                                            <?php }
                                                         } ; ?>  
