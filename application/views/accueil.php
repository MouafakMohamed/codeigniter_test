...
<body class="vertical-layout vertical-menu-modern 2-columns  navbar-floating footer-static " data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
                                ...
                                <div class="card-header d-flex align-items-start pb-0">
                                    <div>
                                      <?php $total = 0;
                                        ...
                                        <p class="mb-0" ><h3  style="color: #1991FA;" class="text-bold-700" ><b style="padding-right: 50px"><?php echo $total.' DH'; ?></b></h3></p>
                                    </div>
                                ...
                                <div class="card-header d-flex align-items-start pb-0">
                                    <div>
                                      ...
                                      if ($now1 == $date3) {
                                        ...
                                        <p class="mb-0" ><h3 style="color: #1991FA;" class="text-bold-700" ><b style="padding-right: 50px"><?php echo $total1.' DH'; ?></b></h3></p>
                                    </div>
  ...
  columnChart.render();
   ...
   <?php $cheque = $this->Model->get('check');
        $date = date('Y-m-d');
        foreach ($cheque as $key) {
          if ($key->payer != 'oui') {
          
          $cli = $this->Model->get_by('cliens','id',$key->clien);
             foreach ($cli as $key1) {
              $clien = $key1->nom.' '.$key1->pre;
             }
           if ($key->date >= $date) { ?>
             <script type="text/javascript">
               $(document).ready(function () {
                //$('#fast-duration').on('click', function () {
                    toastr.warning("<a href='<?php echo base_url(); ?>Cheques'> La date d'encaissement de chèque est arrivée!</a>", "chèque (<?php echo ' '.$clien; ?>)", { "showDuration": 500 });
                  // alert('salam');
               // });
               });
             </script>
