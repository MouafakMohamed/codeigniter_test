                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-12">
                                            <center> <button name="sub" type="submit" class="btn btn-primary"> <i class="feather icon-file" style="margin-right:10px"></i>Ajouter un Fournisseur</button></center> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
											...
											<div class="col-sm-12 col-12">
                                              ...
                                              <center>  <button type="submit" class="btn btn-primary">  <i class="feather icon-file" style="margin-right:10px"></i>Ajouter</button></center> 
                                            </div>
                                        </div>
                                    </div>
                                </div>
