        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Catégories</h2>
            ...
            <div class="content-body">
                ...
                <!-- Input with Icons start -->
                    <div><button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#categorie">  <i class="feather icon-plus" style="margin-right:10px"></i>Ajouter nouveau catégorie </button></div><br>
                                                        ...
                                                        <form method="post" action="add_cat">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text" name="name" placeholder="Catégorie" class="form-control">
                                                                </div>
                                                        ...
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
															   ...
															   <center> <h1 style="font-size:40px">  <i class="fa fa-trash-o"></i></h1></center>
                                                                ...
                                                                <div class="modal-footer">
                                                                    <a href="delete_cat?id=<?php echo $key->id; ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
