                        ...
                        <div class="card bg-authentication rounded-0 mb-0 w-100">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="<?php echo base_url(); ?>assets/app-assets/images/pages/lock-screen.png" alt="branding logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-2 pb-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0">Ton session est bloqué</h4>
                                            </div>
                                        </div><b style="color: red"><?php echo $error; ?></b>
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form action="lock_screen" method="post">
                                                    ...
                                                    <a href="logout">ce n'est pas mon compte ?</a>
                                                    <button type="submit" name="sub" class="btn btn-primary float-right">Débloquer</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
