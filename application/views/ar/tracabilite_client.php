 ...
 <?php include('header.php'); ?>
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">الزبون</h2>
            ...
            <div class="content-body" >
			      <section id="ecommerce-searchbar" dir="rtl">
                        <div class="row mt-1">
                            <div class="col-sm-4">
                ...
                <section id="data-thumb-view" class="data-thumb-view-header"  dir="rtl">
