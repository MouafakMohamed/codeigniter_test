            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">إدارة الشيكات البنكية</h2>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="home-tab-fill" data-toggle="tab" href="#home-fill" role="tab" aria-controls="home-fill" aria-selected="true">الشيكات المقبلة</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="profile-tab-fill" data-toggle="tab" href="#profile-fill" role="tab" aria-controls="profile-fill" aria-selected="false">الشيكات المدفوعة</a>
                                            </li>
                                        </ul>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <div class="custom-control custom-switch switch-lg custom-switch-success mr-2 mb-1">
                                                                 ...
                                                                 <label class="custom-control-label" for="customSwitch<?php echo $key->id; ?>">
                                                                     <span class="switch-text-left">مدفوع </span>
                                                                     <span class="switch-text-right">غير مدفوع </span>
                                                                 </label>
                                                             </div>
                                                        </td>
