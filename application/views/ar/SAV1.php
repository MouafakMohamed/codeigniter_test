                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                            <li class="nav-item" style="background-color: #243665">
                                                <a class="nav-link active" id="profile-tab-fill" data-toggle="tab" href="#profile-fill" role="tab" aria-controls="profile-fill" aria-selected="false" style="color: #8BD8BD">الرجوع </a>
                                            </li>
                                            <li class="nav-item"  style="background-color: #8BD8BD">
                                                <a class="nav-link" id="home-tab-fill" data-toggle="tab" href="#home-fill" role="tab" aria-controls="home-fill" aria-selected="true" ><b style="color: #243665">خدمة ما بعد البيع </b></a>
                                            </li>
                                        ...
                                        <div class="tab-content pt-1">
                                            ...
                                            <div class="tab-pane" id="home-fill" role="tabpanel" aria-labelledby="home-tab-fill">
                                                <button type="button" class="btn btn-outline-primary btn-block " data-toggle="modal" data-target="#inlineForm" style="width: 400px" ><i class="fa fa-plus" style="margin-right:20px"></i>اضافة شكوى </button>
                                           <div class="table-responsive">
                                            <table class="table table-striped table-bordered complex-headers">
                                                <thead>
                                                    <tr>
                                                        <th><center>صورة </center></th>
                                                      
                                                        <th><center>مرجع/الرمز الشريطي </center></th>
                                                        <th><center>تاريخ الشكوى</center></th>
                                                     
                                                        <th  style="width:40%"><center>تعليق </center></th>
                                    ...
                                    <div class="tab-pane active" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
                                        <form method="get">
                                             <div class="row mt-1">
                                            <div class="col-sm-3">
                                            <input type="number" name="facture" class="form-control" placeholder="ادخل رقم الفاتورة ...">
                                        </div>
                                        <div class="col-sm-3">
                                            <button type="submit" class="btn btn-success float-left"> بحث </button>
                                        </div></div>
                                        </form>
                                               <div class="table-responsive">
                                                                            <table class="table zero-configuration">
                                                                               ...
                                                                               <tfoot>
                                                                                <?php if (!empty($query)) { ?>
                                                                                   <tr>
                                                                                        <td colspan="4"></td>
                                                                                        <td><button type="button" data-toggle="modal" data-target="#danger<?php echo $key->id; ?>" class="btn btn-outline-danger mr-1 mb-1"><!--<i class="feather icon-x"></i>--> حذف  </button></td> 
                                                                                   </tr>
                                                                               <?php } ?>
                                                                               </tfoot>
