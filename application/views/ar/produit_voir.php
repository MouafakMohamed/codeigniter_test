...
<body class="vertical-layout vertical-menu-modern content-detached-left-sidebar ecommerce-application navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="content-detached-left-sidebar">
 ...
 multiple="multiple"
                    ...
                    <div class="card ecommerce-card">
                        <div class="card-content">
                           ...
                           <!-- <div class="item-options text-center">
                             ...
                             <div class="item-options text-center">
                                <div class="wishlist remove-wishlist" data-toggle="modal" data-target="#danger<?php echo $key->id; ?>" style="width:150px">
                                    <i class="feather icon-x align-middle"></i> حذف 
                                </div>
                                  <a class="cart" data-toggle="modal" data-target="#large<?php echo $key->id; ?>">  <div class="cart move-cart" style="width: 150px">
                                <i class="feather icon-edit"></i> <span class="add-to-cart">تعديل</span>
                                </div></a>
                            </div>-->
                        </div>
                ...
                <?php
                    ...
                    if ($num > ($n1/9)) {
                       ...
                       $add = $num ;
                        ...
                        echo '<li class="page-item next-item"><a class="page-link" href="produit?page='.$pre.'">
                    ...
                    echo '<li class="page-item prev-item"><a class="page-link" href="produit?page='.$add.'"><i class="feather icon-chevron-left"></i></a></li>';
                        ?>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <section id="ecommerce-pagination">
                        <div class="row">
                            <div class="col-sm-12">
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-center mt-2">
                                        <li class="page-item prev-item"><a class="page-link" href="<?php echo base_url(); ?>assets/#">
                                                <i class="feather icon-chevron-left"></i>
                                            </a></li>
                                        <li class="page-item active"><a class="page-link" href="<?php echo base_url(); ?>assets/#">1</a></li>
                                        ...
                                        <li class="page-item" aria-current="page"><a class="page-link" href="<?php echo base_url(); ?>assets/#">4</a></li>
                                        <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>assets/#">5</a></li>
                                        <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>assets/#">6</a></li>
                                        <li class="page-item"><a class="page-link" href="<?php echo base_url(); ?>assets/#">7</a></li>
                                        <li class="page-item next-item"><a class="page-link" href="<?php echo base_url(); ?>assets/#">
                                                <i class="feather icon-chevron-right"></i>
                                            </a></li>
                                    </ul>
                                </nav>
            ...
            <div class="sidebar-detached sidebar-left"  dir="rtl">
                <div class="sidebar">
...
<script type="text/javascript">
     function searsh(){
                           ...
                           if (searsh != '') {
                            $.ajax({
                              url:"ajax_search_produit10_voir",
                              method:"POST",
                              data:{searsh:searsh},
