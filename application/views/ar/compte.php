                                    ...
                                    <div class="card-body card-dashboard">
                                        ...
                                        <tbody>
                                            ...
                                            <img src="<?php echo base_url(); ?>upload/compte/<?php echo $key->image ; ?>" alt="avtar img holder" height="32" width="32">
                                                ...
                                                <td><a href="POUVOIRS?id=<?php echo $key->id; ?>"><h3 style="color: blue"><i class="feather icon-eye"></i></h3></a></td>
                                                <td> <h3>  <i class="feather icon-edit" data-toggle="modal" data-target="#large<?php echo $key->id; ?>"></i></h3></td>
