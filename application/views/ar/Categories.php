     ...
     <?php include('header.php'); ?>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
             <button type="submit" class="btn btn-primary"  data-toggle="modal" data-target="#inlineForm">  <i class="feather icon-plus" style="margin-left:10px"></i>   اضف صنف</button><br><br>
                                                        ...
                                                        <form method="post" action="add_cat">
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <input type="text"  name="name" placeholder="الصنف" class="form-control">
                                                                </div>
                                                            </div>
