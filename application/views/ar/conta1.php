                        ...
                        <div class="col-sm-12">
                            <div class="card overflow-hidden">
                                <div class="card-header">
                                    <h2 class="card-title"><b>المصاريف </b></h2>
                                </div>
                            ...
                            <div class="col-sm-3" style="float: left;">
                                 <div class="form-group">
                                    <select class="select2-customize-result form-control search-product" onchange="change()" id="select2-customize-result">
                                        <option value="tous"> جميع المصاريف </option>
                                         <?php  
                                                                   ...
                                                                   <div class="row">
                                                                    ...
                                                                    <div class="col-sm-12 col-12">
                                                                        ...
                                                                        montant
                                                                         ...
                                                                         <fieldset class="form-group position-relative input-divider-right">
                                                                             <input type="number" name="montant" class="form-control" id="iconLeft4" placeholder="1500" required="" >
                                                                             <div class="form-control-position">
                                                                                 <i class="feather icon-user"></i>
                                                                             </div>
                                                                         </fieldset>
