            ...
            <div class="content-header row">
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">حركة الفواتير</h2>
                            ...
                            <tbody>
                               <?php foreach ($bons as $key) { ?>
                                <tr>
                                   ...
                                   <td><a href="invoice?id=<?php echo $key->id_bons; ?>"><button type="button" class="btn btn-outline-primary mb-2"  >  <i class="fa fa-print"></i></button></a></td>
                                </tr>
                                <?php } ?>
