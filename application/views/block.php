                        ...
                        <div class="card auth-card bg-transparent shadow-none rounded-0 mb-0 w-100">
                            <div class="card-content">
                                <div class="card-body text-center">
                                    <img src="<?php echo base_url(); ?>assets/app-assets/images/pages/not-authorized.png" class="img-fluid align-self-center" alt="branding logo">
                                    <h1 class="font-large-2 my-2">Votre compte est desactiver!</h1>
                                   <!-- <p class="p-2">
                                    ...
                                    <a class="btn btn-primary btn-lg mt-2" href="logout">logout</a>
                                </div>
                            </div>
                        </div>
                    </div>
