                                ...
                                <div class="table-responsive">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:10%">EFFACER</th>
                                                <th style="width:12%">INITIALISER</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <img src="<?php echo base_url(); ?>upload/compte/<?php echo $key->image ; ?>" alt="avtar img holder" height="32" width="32">
                                                ...
                                                <td><center><div class="custom-control custom-switch custom-switch-danger mr-2 mb-1">
                                                    <?php if ($key->active == 'non') { ?>
                                                       <input type="checkbox" onclick="salam(<?php echo $key->id; ?>)" class="custom-control-input" id="customSwitch<?php echo $key->id; ?>" >
                                                    <?php }else{ ?>
                                                     <input type="checkbox" onclick="salam(<?php echo $key->id; ?>)" class="custom-control-input" id="customSwitch<?php echo $key->id; ?>"checked>
                                                   <?php } ?>
                                                <label class="custom-control-label" for="customSwitch<?php echo $key->id; ?>"></label>
                                            </div></center></td>
                                                <td><h3><a href="POUVOIRS?id=<?php echo $key->id; ?>">  <i class="feather icon-eye"></i></a></h3></td>
                                               ...
                                               <td> <h3 style="color: green"><i class="feather icon-rotate-cw" data-toggle="modal" data-target="#danger1<?php echo $key->id; ?>"></i></h3></td>
                                         ...
                                         <div class="col-sm-6 col-12">
                                            ...
                                            <div class="col-sm-6 col-12">
                                             ...
                                             Post occupé
                                                ...
                                                <fieldset class="form-group position-relative input-divider-right">
                                                    <input type="text" name="post" class="form-control" id="iconLeft4" placeholder="Post occupé" required="">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-mail"></i>
                                                    </div>
                                                </fieldset>
                                       ...
                                       Type de contrat
                                              ...
                                              <div class="col-sm-6 col-12">
                                               ...
                                               Salaire
                                                ...
                                                <fieldset class="form-group position-relative input-divider-right">
                                                    <input type="number" name="salaire" class="form-control" id="iconLeft4" value="0">
                                                    <div class="form-control-position">
                                                        <i class="feather  icon-dollar"></i>
                                                    </div>
                                                </fieldset>
                                            </div>
                                             <div class="col-sm-6 col-12">
...
<?php foreach ($compte as $key) { ?>
                                                 <div class="modal fade text-left" id="large<?php echo $key->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title" id="myModalLabel17">Modifier le compte</h4>
                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                        <span aria-hidden="true">&times;</span>
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="modal-body">
                                                                   <div class="row">
                                               <div class="col-sm-6 col-12">
                                                <div class="text-bold-600 font-medium-4 mb-1" >
                                                   Nom
                                                </div>
                                                <fieldset class="form-group position-relative input-divider-right">
                                         ...
                                         <div class="col-sm-6 col-12">
                                               ...
                                               Tél
                                                ...
                                                <fieldset class="form-group position-relative input-divider-right">
                                                    <input type="number" name="tele" class="form-control" id="iconLeft4" value="<?php echo $key->tele ; ?>" required="">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-phone"></i>
                                                    </div>
                                                </fieldset>
                                            ...
                                            <div class="col-sm-6 col-12">
                                             ...
                                             Post occupé
                                                ...
                                                <fieldset class="form-group position-relative input-divider-right">
                                                    <input type="text" name="post" class="form-control" id="iconLeft4" value="<?php echo $key->post ; ?>" required="">
                                                    <div class="form-control-position">
                                                        <i class="feather icon-mail"></i>
                                                    </div>
                                                </fieldset>
                                       ...
                                       Type de contrat
                                           ...
                                           <div class="col-sm-6 col-12">
                                               ...
                                               Salaire
                                                ...
                                                <fieldset class="form-group position-relative input-divider-right">
                                                    <input type="number" name="salaire" class="form-control" id="iconLeft4" value="<?php echo $key->salaire ; ?>">
                                                    <div class="form-control-position">
                                                        <i class="feather  icon-dollar"></i>
                                                    </div>
                                                </fieldset>
...
<?php foreach ($compte as $key) { ?>
     <div class="modal fade text-left" id="danger<?php echo $key->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                ...
                                                <?php } ?>
                                                <?php foreach ($compte as $key) { ?>
     <div class="modal fade text-left" id="danger1<?php echo $key->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel120" aria-hidden="true">
                                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header bg-danger white">
                                                                    <h5 class="modal-title" id="myModalLabel120"></h5>
                                                               ...
                                                               <center> <h1 style="font-size:40px">  <i class="fa fa-trash-o"></i></h1></center>
                                                                <center> <h1 style="font-size:30px">   Êtes-vous sûr de redémarrer le mot de pass pour ce compte ? </center> 
                                                                </div>
                                                                <div class="modal-footer">
                                                                    <a href="modifier_pass?id=<?php echo $key->id; ?>"><button type="submit" class="btn btn-danger">redémarrer</button></a>
                                                                    <button type="button" class="btn btn-outline-danger" data-dismiss="modal">Annuler</button>
                                                                </div>
                                                            </div>
                                                        </div>
