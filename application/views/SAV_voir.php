                                                    ...
                                                    <tr>
													    <td>    
                                                            <div class="avatar mr-1 ">
                                                                <img src="<?php echo base_url(); ?>assets/app-assets/images/portrait/small/avatar-s-20.png" alt="avtar img holder" height="32" width="32">
                                                            </div>
                                                        </td>
                                                        <td><?php $pro = $this->Model->get_by('produit','id',$key->pro);
                                                        foreach ($pro as $key1) {
                                                              echo $key1->name;
                                                          }  ?></td>
