                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                                            <li class="nav-item"  style="background-color: #8BD8BD">
                                                <a class="nav-link active" id="home-tab-fill" data-toggle="tab" href="#home-fill" role="tab" aria-controls="home-fill" aria-selected="true" ><b style="color: #243665">Ressources humaines</b></a>
                                            </li>
                                            <li class="nav-item" style="background-color: #243665">
                                                <a class="nav-link" id="profile-tab-fill" data-toggle="tab" href="#profile-fill" role="tab" aria-controls="profile-fill" aria-selected="false" style="color: #8BD8BD">Les salaires</a>
                                            </li>
                                        </ul>
                                            ...
                                            <table class="table zero-configuration">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button type="button" class="btn btn-flat-success border-success text-success mr-1 mb-1" onclick="promt(<?php echo $key->id; ?>)" id="prompt-function">  Valider </button></td>
